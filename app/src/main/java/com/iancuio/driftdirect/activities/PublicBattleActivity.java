...
public class PublicBattleActivity extends AppCompatActivity {
        ...
        playoffBattleViewPublicBattleCall.enqueue(new retrofit.Callback<PlayoffBattleViewPublicBattle>() {
            ...
            public void onResponse(final Response<PlayoffBattleViewPublicBattle> response, Retrofit retrofit) {
                ...
                if (response.code() == 200) {
                    ...
                    dialog.dismiss();
                    Utils.showAlertDialog(PublicBattleActivity.this, "Attention!", "Please wait for the other judges to give their scores for the current run!", "Please wait for the other judges to give their scores for the first run!");
                } else {
                    dialog.dismiss();
    ...
    private void populateView(int position) {
        ...
        Utils.loadNormalImage(200, 200, PublicBattleActivity.this, RestUrls.FILE + playoffBattleViewPublicBattle.getDriver1().getDriver().getProfilePicture(), firstDriverPictureImageView, new Callback() {
            @Override
        ...
        Utils.loadNormalImage(100, 100, PublicBattleActivity.this, RestUrls.FILE + playoffBattleViewPublicBattle.getDriver1().getDriver().getCountry(), firstDriverFlag, new Callback() {
            @Override
            public void onSuccess() {
            }
...
//                });
        ...
        Utils.loadNormalImage(200, 200, PublicBattleActivity.this, RestUrls.FILE + playoffBattleViewPublicBattle.getDriver2().getDriver().getProfilePicture(), secondDriverPictureImageView, new Callback() {
            @Override
            public void onSuccess() {
                firstDriverPictureProgressBar.setVisibility(View.GONE);
            }
        ...
        Utils.loadNormalImage(100, 100, PublicBattleActivity.this, RestUrls.FILE + playoffBattleViewPublicBattle.getDriver2().getDriver().getCountry(), secondDriverFlag, new Callback() {
            @Override
            public void onSuccess() {
            }
