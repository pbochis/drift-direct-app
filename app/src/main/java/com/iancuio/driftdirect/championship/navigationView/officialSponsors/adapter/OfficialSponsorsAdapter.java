package com.iancuio.driftdirect.championship.navigationView.officialSponsors.adapter;
...
public class OfficialSponsorsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ImageUtils.loadNormalImage(400, 400, context, RestUrls.FILE + sponsorList.get(position).getLogo(), newsViewHolder.newsImage, new Callback() {
            @Override
