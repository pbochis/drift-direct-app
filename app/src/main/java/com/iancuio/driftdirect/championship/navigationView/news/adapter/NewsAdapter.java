package com.iancuio.driftdirect.championship.navigationView.news.adapter;
...
public class NewsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ImageUtils.loadNormalImage(400, 400, context, RestUrls.FILE + newsList.get(position).getLogo(), newsViewHolder.newsImage, new Callback() {
            @Override
