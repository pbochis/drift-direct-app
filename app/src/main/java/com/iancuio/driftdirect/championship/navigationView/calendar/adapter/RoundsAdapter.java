package com.iancuio.driftdirect.championship.navigationView.calendar.adapter;
...
public class RoundsAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        ImageUtils.loadNormalImage(600, 600, context, RestUrls.FILE + roundsList.get(i).getLogo(), viewHolder.roundsImageImageView, new Callback() {
            @Override
