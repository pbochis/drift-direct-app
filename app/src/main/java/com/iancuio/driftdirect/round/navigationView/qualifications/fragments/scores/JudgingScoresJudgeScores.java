...
import com.iancuio.driftdirect.round.navigationView.top32_16.activities.judgeBattle.adapters.JudgePointsAllocationAdapter;
...
public class JudgingScoresJudgeScores extends Fragment {
    ...
    private void getAllocationPoints(List<JudgePointsAllocation> judgePointsAllocationList) {
        ...
        SizeUtils.setListViewHeightBasedOnItems(pointsAllocationListListView);
    }
    ...
    public void showPopup(final View anchorView, boolean positiveComments) {
        ...
        int percentHeight = (int) (((getResources().getDisplayMetrics().heightPixels) - SizeUtils.getStatusBarHeight(getActivity())) * 0.80);
