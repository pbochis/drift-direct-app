package com.iancuio.driftdirect.round.navigationView.trackLayout;
...
public class SubTrackLayoutFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageUtils.loadNormalImage(600, 600, getActivity(), RestUrls.FILE + roundFull.getTrack().getLayout(), trackCartoonImageImageView, new Callback() {
            @Override
