 ...
 *  to be notified when the thumbs have
 * been moved.
 */
public class RangeBar extends View {
    ...
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.drawable.battle_thumb_shape;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.drawable.battle_thumb_shape;
...
//                                mThumbImagePressed);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mConnectingLine.draw(canvas, mLeftThumb);
